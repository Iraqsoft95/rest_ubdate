USE [RESTAURANT_DB]
GO
/****** Object:  StoredProcedure [dbo].[P_CHECK_EXIST_COLUMNS]    Script Date: 2024/09/23 12:18:30 ******/
...
END
 ELSE
 BEGIN
IF NOT EXISTS (SELECT 1 FROM T_CLIENT WHERE CLIENT_CODE = 0) INSERT [dbo].[T_CLIENT] ([CLIENT_CODE], [CLIENT_NAME], [CLIENT_PHONE], [CLIENT_REGION], [CLIENT_ADDRESS], [CLIENT_ACTIVE]) VALUES (0, N'Ø¹Ù…ÙŠÙ„ Ù†Ù‚Ø¯ÙŠ', N'', N'', N'', 1) 
 END
 --////////////////////////////////////////////////////////////T_RECIPIENTS/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
END
 ...
 BEGIN
 EXEC('UPDATE T_SALES SET RECIPIENT_CODE=0 WHERE RECIPIENT_CODE IS NULL')
IF NOT EXISTS (SELECT 1 FROM T_RECIPIENTS WHERE RECIPIENT_CODE = 0) INSERT [dbo].T_RECIPIENTS (RECIPIENT_CODE, [RECIPIENT_NAME], [DISCOUNT_PERCENT], [RECIPIENT_BARCODE],[ACTIVE]) VALUES (0, N'ØºÙŠØ± Ù…Ø­Ø¯Ø¯',0, N'',  1) 
 END
  --////////////////////////////////////////////////////////////T_IVC_TYPE/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
END
 ELSE
 BEGIN
IF NOT EXISTS (SELECT 1 FROM T_IVC_TYPE WHERE IVC_CODE = 0) INSERT [dbo].[T_IVC_TYPE] ([IVC_CODE], [IVC_NAME]) VALUES (0, N'Ù†Ù‚Ø¯ÙŠ')
IF NOT EXISTS (SELECT 1 FROM T_IVC_TYPE WHERE IVC_CODE = 1) INSERT [dbo].[T_IVC_TYPE] ([IVC_CODE], [IVC_NAME]) VALUES (1, N'Ø§Ø¬Ù„')
 END
